...
# ggsave("DB/benford_Nupr.png", dpi = 150, bg = "white", width = 7, height = 5)
```
...
# ggsave("DB/benford_Nawr.png", dpi = 150, bg = "white", width = 7, height = 5)
```
...
# ggsave("DB/benford_Duda.png", dpi = 150, bg = "white", width = 7, height = 5)
```
